                        ...
                        <div key={"page-" + index}>
                            {
                                page.map((cat, paw) => (
                                    <div key={"cat-" + paw}
                                    //  ref={data.pages.length === index + 1 && page.length - 2 === paw ? lastCatRef : null}
                                    >
                                        {/* {data.pages.length === index + 1 && page.length - 2 === paw ? "last" : null} */}
                                        <Image cat={cat} width={300} scrollPosition={scrollPosition} />
                                    </div>
                                ))
                            }
                        </div>
